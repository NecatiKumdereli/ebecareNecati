window.addEventListener("load", function () {
    ...
    var aaa = "/theme/src/assets/img/logo2.svg";
    var settingsObject = {
    ...
    if (corkThemeObject.settings.layout.darkMode) {
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '/theme/src/assets/img/logo.svg')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
        ...
        if (!getParseObject.settings.layout.darkMode) {
            ...
            var aaa = "/theme/src/assets/img/logo2.svg";
            console.log("wwww----", getParseObject.settings.layout.logo);
            document.querySelector('.navbar-logo').setAttribute('src', aaa)
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', aaa)
                }
